...
public class Java8ProgrammingQA {
    public static void main(String[] args) {
        ...
        /**
         * Find the students whose stays in karnataka and sort them by their names
         */
        List<Student> studentByCity = studentList.stream().filter(student -> student.getCity().equals("Karnataka"))
        ...
        List<String> deptNames = studentList.stream()
                .map(Student::getDept).distinct().collect(Collectors.toList());
        //System.out.println(deptNames);
        //If we do not use distinct then we have to use set Interface like this
        Set<String> deptNamesInSet = studentList.stream()
                .map(Student::getDept)
        ...
        /**
         * Group by Students By Departments names
         */
        ...
        /**
         * Find the Departments who is having maximum numbers of Students
         */
        ...
        /**
         * Find the average age of male or female students
         */
         ...
         */
        Map<String, Optional<Student>> studentHighestRank = studentList.stream()
                .collect(Collectors.groupingBy(Student::getDept, Collectors.minBy(
                        Comparator.comparing(Student::getRank)
                )));
        // System.out.println(studentHighestRank);


        /**
         * Find the Students who has Second rank
         */
